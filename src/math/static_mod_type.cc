...
template<typename _Tp>
static_mod_type<_Tp>::operator int() const { return value; }

template<typename _Tp>
static_mod_type<_Tp>::operator int64_t() const { return value; }

template<typename _Tp>
static_mod_type<_Tp>::operator float() const { return value; }

template<typename _Tp>
static_mod_type<_Tp>::operator double() const { return value; }

template<typename _Tp>
static_mod_type<_Tp>::operator long double() const { return value; }
